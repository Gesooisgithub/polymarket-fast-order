...
class PolymarketHotkeyApp:
    ...
    def _register_hotkeys_standard(self) -> None:
        ...
        self.hotkey_manager.register_hotkey(
            ...
            lambda: self.trader.execute_order(OrderSide.BUY_YES, self.current_amount)
        )
        self.hotkey_manager.register_hotkey(
            "buy_no",
            hotkeys.get("buy_no", "ctrl+2"),
            lambda: self.trader.execute_order(OrderSide.BUY_NO, self.current_amount)
        )
        ...
        self.hotkey_manager.register_hotkey(
            ...
            lambda: self.trader.execute_order(OrderSide.SELL_YES, self.current_amount)
        )
        self.hotkey_manager.register_hotkey(
            "sell_no",
            hotkeys.get("sell_no", "ctrl+4"),
            lambda: self.trader.execute_order(OrderSide.SELL_NO, self.current_amount)
        )
