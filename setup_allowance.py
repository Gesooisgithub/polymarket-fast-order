"""
Setup script to approve pUSD spending on Polymarket CLOB V2 contracts.
...
PUSD_ADDRESS = "0xC011a7E12a19f7B1f670d46F03B03f3342E82DFB"  # pUSD (V2 collateral token)
CTF_ADDRESS = "0x4D97DCd97eC945f40cF65F87097ACe5EA0476045"  # Conditional Token Framework (ERC1155)

# Polymarket contracts that need pUSD approval (V2)
...
def main():
    print("=" * 60)
    print("Polymarket Allowance Setup (CLOB V2 - pUSD)")
    print("=" * 60)
    print()
    ...
    usdc_balance_formatted = usdc_balance / 1e6  # pUSD has 6 decimals
    print(f"pUSD Balance: ${usdc_balance_formatted:.2f}")
    print()
    ...
    for name, contract_address in POLYMARKET_CONTRACTS.items():
        ...
        print(f"  Approving unlimited pUSD spending...")
